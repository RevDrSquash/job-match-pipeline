...
| [TASKS_AND_HANDLERS.md](TASKS_AND_HANDLERS.md) | The pipeline handlers, queue configuration, data model sketch |
...
| [KNOWN_LOG_NOISE.md](KNOWN_LOG_NOISE.md) | Log and warning output that looks alarming but is expected — check before debugging |
